package com.programmer.escrow.dispute.controller.client;
...
@RestController
@RequestMapping("/api/client/disputes")
public class ClientDisputeController {

    private final DisputeService disputeService;

    public ClientDisputeController(DisputeService disputeService) {
